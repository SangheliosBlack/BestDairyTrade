            ...
            return Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Te conectamos y",
                        style: GoogleFonts.pacifico(
                            color: Colors.black, fontSize: 30)),
                    Text("PROVEEMOS TUS RECURSOS",
                        style: GoogleFonts.anton(
                            color: Themes.secondary, fontSize: 30, height: 1)),
                    Text("CON MAS DE 100 PROVEEDORES ONLINE",
                        style: GoogleFonts.anton(
                            color: Themes.primary, fontSize: 30, height: 1)),
                    Container(
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: FittedBox(
                                  child: Text(
                                    "+200 OPORTUNIDADES DIARIAS",
                                    style: GoogleFonts.anton(
                                        height: 1, color: Themes.secondary),
                                  ),
                                ),
                              ),
                            ],
